...
const DeputyHeadteacherDashboard = () => {
  ...
  return (
    <div className="p-6 bg-blue-50 min-h-screen">
      <h1 className="text-3xl font-bold text-blue-900 mb-8">Deputy Headteacher Dashboard</h1>
...
export default DeputyHeadteacherDashboard;